      ...
      <div className="glass-card rounded-2xl p-5 border border-slate-200/80 shadow-sm flex items-start gap-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-slate-500 leading-relaxed">
            Paste your CV/Resume or Statement of Purpose alongside a target job post or university program syllabus. MyTraks analyzes matching scores, reveals missing ATS keywords, and suggests bullet-point improvements in real-time.
          </p>
        </div>
      </div>
