...
export default function SidebarFooter({ userName, userEmail }: SidebarFooterProps) {
  return (
    <div className="p-4 border-t border-slate-200/80 bg-slate-50/50">
      <div className="flex items-center gap-3 px-4 py-3 mb-2 rounded-2xl bg-slate-100 border border-slate-200/60">
        <div className="w-9 h-9 rounded-full bg-brand-indigo/25 border border-brand-indigo/35 flex items-center justify-center">
