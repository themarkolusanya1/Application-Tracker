...
import { 
  ...
  MapPin, DollarSign, Calendar, ExternalLink, Edit2, Trash2, ArrowUpDown, Sparkles, AlertCircle, ArrowRight, AlertTriangle
} from 'lucide-react';
...
export default function DashboardClient({ 
                ...
                <div className="flex items-center gap-3">
                  {urgentClosingApps.length > 0 && (
                    ...
                    >
                      ...
                      <span>Urgent Closing ({urgentClosingApps.length})</span>
                    </button>
                  )}
                  <button
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      {/* 5. Urgent Closing Applications Popup Modal */}
      <Dialog open={showUrgentModal} onOpenChange={setShowUrgentModal}>
        <DialogContent showCloseButton={false} className="sm:max-w-xl w-full p-0 overflow-hidden bg-slate-950 border border-rose-500/40 rounded-2xl shadow-2xl flex flex-col max-h-[85vh] text-white">
