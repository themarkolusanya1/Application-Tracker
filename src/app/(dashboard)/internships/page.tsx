...
export default async function InternshipsPage() {
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-8">
        <h3 className="text-2xl font-black text-white tracking-tight">Internships</h3>
        <p className="text-sm text-gray-400 mt-1">
          Direct dashboard entry for your corporate internship applications.
        </p>
      </div>
      
      <DashboardClient initialApplications={applications} initialTab="internship" hideTabs={true} />
    </div>
  );
}
